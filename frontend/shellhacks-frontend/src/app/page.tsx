  ...
  return (
    <div className="  h-screen w-screen flex bg-linear-to-bl from-[#6c5ccc] to-[#3251c3]">
      <div className="block bg-[#0a014fc3] h-screen w-2/3 border-4 border-solid border-[#0d016dc3] inset-shadow-sm/50 rounded-tr-2xl rounded-br-2xl">
        ...
        <h4 className="absolute bottom-10 left-10 text-4xl font-semibold text-white">Your time for memories, not logistics.</h4>
      </div>
      <div className="h-screen w-1/3 text-center py-[10%]">
        ...
        <div className="flex flex-col mx-[20%]">
          <button className="btn bg-white text-black border-[#e5e5e5] h-20 rounded-xl my-10 text-xl hover:bg-blue-200 focus:outline-2 focus:outline-offset-2 focus:black active:bg-blue-700">
